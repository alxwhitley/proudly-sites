...
- Memorable moment: the centered serif hero with terracotta italic emphasis and direct-work founder chip resolves into a compact proof strip before the case-study sequence.
- Fidelity inventory: semantic nav, headings, body copy, buttons, tags, process cards, testimonial cards, and footer columns in HTML/CSS; project and founder photography as local raster assets; no generated imagery ships.
...
- Scope boundary: the centered first viewport, exact narrative order, content mismatches, and footer sitemap are homepage-specific fidelity decisions and are not promoted to global design-system rules. The decorative star field was removed and is no longer part of the approved surface.
