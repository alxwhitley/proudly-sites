...
slug: legacy-renovations
headline: Craftsmanship homeowners can see before they call
description: How a Raleigh kitchen and bathroom renovation company got its first real brand and a site that leads with the finished work.
summary: Craftsmanship homeowners can see before they call.
niche: Kitchen & Bath
location: Raleigh
services:
  - Brand strategy
  - Web design
  - Search foundations
heroImage: ../../../assets/case-studies/legacy-renovations/hero.jpeg
heroAlt: A finished Legacy Renovations kitchen remodel leading the site
liveUrl: https://www.legacykitchenbathroomrenovations.com
featured: true
order: 2
status: published
...
homepage:
  body: Homeowners hire the remodeler they trust with their house. This build leads with the finished work and makes requesting a quote feel like the natural next step.
  tags:
    - First Real Brand
    - SEO-Optimized Service Pages
    - Before/After Portfolio
    - Service-Based Navigation
  quoteExcerpt: “The design looks amazing, the site runs smoothly, and everything was completed on time.”
  quoteCite: Tony R. — Legacy Renovations
---

Case-study content is stored in frontmatter because the shared presentation renders each narrative section from structured fields.
